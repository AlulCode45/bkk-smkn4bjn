    ...
    <section class="">
        <div class="position-relative">
            <div id="carouselExampleFade" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item">
                        <img src="{{ asset('assets/images/photos/Background1.jpg') }}" alt=""
                            class="position-absolute background1">
                    </div>
                    <div class="carousel-item active">
                        <img src="{{ asset('assets/images/photos/Background2.jpg') }}" alt=""
                            class="position-absolute background2">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('assets/images/photos/Background3.jpg') }}" alt=""
                            class="position-absolute background3">
                    </div>
                    <div data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-once="true"
                        ...
                        <div class="carousel-content d-flex">
                            ...
                            <span class="carousel-span d-none d-block">Membimbing, Karakter, Kerjasama, Sukses (MKKS)</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="position-absolute top-0 start-0 carousel-button mt-4 mt-md-1" data-aos="fade-up"
                ...
                <a href="https://drive.google.com/file/d/178KsA6qybm4weBGecY7W9H75QPA9fsti/preview"
                    class="btn btn-outline-success" data-lity>
                    <div class="d-flex">
                        <div>
                            <ion-icon name="play-circle-outline"></ion-icon>
                        </div>
                        <div class="text-play ms-1">Lihat Presentasi</div>
                    </div>
                </a>
            </div>
        </div>
