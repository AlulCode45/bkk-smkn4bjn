...
@section('content')
    ...
    <div class="container">
        <div class="bg-light p-3 mb-5">
            <form action="{{ route('data_perusahaan') }}" method="get">
                <div class="search">
                    ...
                    <div class="card card-margin">
                        <div class="card-header no-border bg-light d-flex">
                            ...
                            <div class="ms-auto">
                                ...
                                @endif
                                @if ($data->umkm == 1)
                                    <span class="badge rounded-pill bg-danger">UMKM</span>
                                @endif
                            </div>
                        ...
                        <div class="card-body pt-0">
                            <div>
                                <span class="widget-49-pro-title">
                                    <p class="text-card-perusahaan">Tahun gabung : {{ $data->tahun_gabung }}</p>
                                </span>
                            </div>
                            <div>
                                <span class="widget-49-pro-title">
                                    <p class="text-card-perusahaan">Alamat : {{ $data->alamat }}</p>
                                </span>
                            </div>
                        </div>
