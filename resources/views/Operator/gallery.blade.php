...
@section('name-page', 'Daftar Gallery')
@section('css')
    <style>
        iframe {
            background: gray;
                    ...
                    <tbody>
                        @foreach ($data_gallery as $gallery)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('operator.editFoto', $gallery->id) }}" class="btn btn-primary m-1"><i
                                            class="fa fa-pencil-alt"></i></a>
                                    <a href="{{ route('operator.hapusFoto', $gallery->id) }}" class="btn btn-danger m-1"><i
    ...
    <div class="modal fade" id="tambahGallery" tabindex="" role="dialog" aria-labelledby="tambahGalleryLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('operator.tambahFoto') }}" method="post" enctype="multipart/form-data">
                    @csrf
