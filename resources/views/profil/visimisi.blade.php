...
@section('content')
    ...
    <div class="container">
        <div class="text-center">
            <h3 class="text-russo">Visi Misi BKK</h3>
        </div>
        <div class="row-cols-1 row-cols-md-2">
            <div class="col visi-bkk" data-aos="fade-right" data-aos-offset="300" data-aos-duration="1000">
                <h3 class="visimisi-bkk">Visi BKK SMKN 4 Bojonegoro</h3>
                <p>{!! $visi !!}</p>
            </div>
            <div class="col">
            ...
            <div class="col ms-auto misi-bkk" data-aos="fade-left" data-aos-duration="1000">
                <h3 class="visimisi-bkk">Misi BKK SMKN 4 Bojonegoro</h3>
                {!! $misi !!}
            </div>
        </div>
    </div>
