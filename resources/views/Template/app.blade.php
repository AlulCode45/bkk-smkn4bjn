                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <a class="dropdown-item"
                                    href="{{ Auth::user()->role == 4 ? route('master.profile') : (Auth::user()->role == 3 ? route('operator.profile') : (Auth::user()->role == 2 ? route('perusahaan.profile') : (Auth::user()->role == 1 ? route('siswa.profile') : (Auth::user()->role == 5 ? route('dinas.profile') : '')))) }}"><i
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link"
                                href="{{ Auth::user()->role == 4 ? route('master') : (Auth::user()->role == 3 ? route('operator') : (Auth::user()->role == 2 ? route('perusahaan') : (Auth::user()->role == 1 ? route('siswa') : (Auth::user()->role == 5 ? route('dinas') : '/')))) }}"
                        ...
                        @if (Auth::user()->role == 5)
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('dinas.perusahaan') }}"
                                    aria-expanded="false">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('dinas.lowongan') }}" aria-expanded="false">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('dinas.berita') }}" aria-expanded="false">
                                    <i data-feather="users" class="feather-icon"></i>
                                    <span class="hide-menu">Berita</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('dinas.gallery') }}" aria-expanded="false">
                                    <i data-feather="users" class="feather-icon"></i>
                                    <span class="hide-menu">Gallery</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('dinas.testimoni') }}" aria-expanded="false">
                                    <i data-feather="users" class="feather-icon"></i>
                        ...
                        @elseif (Auth::user()->role == 4)
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('master.testimoni') }}"
                                    aria-expanded="false">
                                    <i data-feather="users" class="feather-icon"></i>
                                    <span class="hide-menu">Testimoni</span>
                                </a>
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('master.angket') }}" aria-expanded="false">
                                    <i data-feather="users" class="feather-icon"></i>
                                    <span class="hide-menu">Angket</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('master.kepuasanPelanggan') }}"
                                    aria-expanded="false">
                                    <i data-feather="users" class="feather-icon"></i>
                                    <span class="hide-menu">Data Kepuasan Pelanggan</span>
                                </a>
                            </li>
                        @elseif (Auth::user()->role == 3)
                            <li class="nav-small-cap"><span class="hide-menu">Menu Pekerjaan</span></li>
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('operator.perusahaan') }}"
                                    aria-expanded="false">
                                    <i data-feather="book" class="feather-icon"></i>
                                    <span class="hide-menu">Daftar Perusahaan</span>
                                </a>
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('operator.lowongan') }}"
                                    aria-expanded="false">
                                    <i data-feather="tag" class="feather-icon"></i>
                                    <span class="hide-menu">Daftar Lowongan</span>
                                </a>
                            ...
                            <li class="nav-small-cap"><span class="hide-menu">Menu Profile</span></li>
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('operator.berita') }}" aria-expanded="false">
                                    <i data-feather="users" class="feather-icon"></i>
                                    <span class="hide-menu">Berita</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('operator.gallery') }}"
                                    aria-expanded="false">
                                    <i data-feather="users" class="feather-icon"></i>
                                    <span class="hide-menu">Gallery</span>
                                </a>
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('operator.testimoni') }}"
                                    aria-expanded="false">
                                    <i data-feather="users" class="feather-icon"></i>
                                    <span class="hide-menu">Testimoni</span>
                                </a>
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('operator.kepuasanPelanggan') }}"
                                    aria-expanded="false">
                                    <i data-feather="users" class="feather-icon"></i>
                                    <span class="hide-menu">Data Kepuasan Pelanggan</span>
                                </a>
                        ...
                        @elseif (Auth::user()->role == 2)
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('perusahaan.testimoni') }}"
                                    aria-expanded="false">
                                    <i data-feather="users" class="feather-icon"></i>
                                    <span class="hide-menu">Testimoni</span>
                                </a>
                        ...
                        @elseif (Auth::user()->role == 1)
                            ...
                            <li class="nav-small-cap"><span class="hide-menu">Menu Laporan</span></li>
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('siswa.testimoni') }}" aria-expanded="false">
                                    <i data-feather="users" class="feather-icon"></i>
                                    <span class="hide-menu">Testimoni</span>
                                </a>
                            </li>
