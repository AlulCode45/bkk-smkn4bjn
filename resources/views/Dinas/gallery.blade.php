                    ...
                    <tbody>
                        @foreach ($data_gallery as $gallery)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('dinas.editFoto', $gallery->id) }}" class="btn btn-primary m-1"><i
                                            class="fa fa-pencil-alt"></i></a>
                                    <a href="{{ route('dinas.hapusFoto', $gallery->id) }}" class="btn btn-danger m-1"><i
    ...
    <div class="modal fade" id="tambahGallery" tabindex="" role="dialog" aria-labelledby="tambahGalleryLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('dinas.tambahFoto') }}" method="post" enctype="multipart/form-data">
                    @csrf
