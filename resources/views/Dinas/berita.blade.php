        ...
        <div class="card-body">
            <div class="row mb-3">
                ...
                <div class="col-6 d-flex">
                    <div class="ml-auto">
                        <a class="btn btn-success rounded rounded-pill" href="{{ route('dinas.tambahBerita') }}">Tambah
                            Berita</a>
                    </div>
                </div>
            </div>
                        ...
                        @foreach ($data_berita as $berita)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('dinas.editBerita', $berita->id) }}" class="btn btn-primary m-1"><i
                                            class="fa fa-pencil-alt"></i></a>
                                    <a href="{{ route('dinas.hapusBerita', $berita->id) }}" class="btn btn-danger m-1"><i
