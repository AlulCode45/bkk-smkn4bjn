                    ...
                    <tbody>
                        @foreach ($lowongan_data as $lowongan)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('dinas.viewLowongan', $lowongan->id) }}"
                                        class="btn btn-success m-1"><i class="fa fa-eye"></i></a>
                                    <a href="{{ route('dinas.editLowongan', $lowongan->id) }}"
                                        class="btn btn-primary m-1"><i class="fa fa-pencil-alt"></i></a>
                                    <a href="{{ route('dinas.hapusLowongan', $lowongan->id) }}"
    ...
    <div class="modal fade" id="tambahLowongan" tabindex="-1" role="dialog" aria-labelledby="tambahLowonganLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('dinas.tambahLowonganAction') }}" method="post">
                    @csrf
            ...
            $(document).ready(function() {
                ClassicEditor
                    .create(document.querySelector('#deskripsi'), {
                        ckfinder: {
                            uploadUrl: '{{ route('dinas.uploadImage') . '?_token=' . csrf_token() }}',
                        }
                    })
                    .catch(error => {
                        console.error(error);
