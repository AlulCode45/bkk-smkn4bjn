...
class LowonganModel extends Model
{
    ...
    public function scopeFilter($query, $filter)
    {
        ...
        $query->where('status', true)->groupBy('lowongan.id')
