...
class DinasController extends Controller
{
    ...
    public function strukturBkk()
    {
        ...
        return view('Dinas.struktur_bkk', $data);
    }
    ...
    public function perusahaan()
    {
        ...
        return view('Dinas.perusahaan', $data);
    }
    ...
    public function editPerusahaan($idPerusahaan)
    {
        ...
        return view('Dinas.edit_perusahaan', $data);
    }
    ...
    public function lowongan()
    {
        ...
        return view('Dinas.lowongan', $data);
    }
    ...
    public function viewLowongan($id)
    {
        ...
        return view('Dinas.view_lowongan', $data);
    }
    public function editLowongan($id)
    {
        ...
        return view('Dinas.edit_lowongan', $data);
    }
    ...
    public function programkerja()
    {
        ...
        return view('Dinas.programkerja', $data);
    }
    ...
    public function sambutankepalasekolah()
    {
        ...
        return view('Dinas.sambutan_kepala_sekolah', $data);
    }
    ...
    public function berita()
    {
        ...
        return view('Dinas.berita', $data);
    }
    public function tambahBerita()
    {
        return view('Dinas.tambah_berita');
    }
    public function tambahBeritaAction(Request $request)
    {
        ...
        if (NewsModel::insert($save)) {
            return redirect()->to(route('Dinas.berita'))->with('success', 'Tambah berita sukses');
        } else {
    ...
    public function editBerita($id)
    {
        ...
        return view('Dinas.edit_berita', $data);
    }
    ...
    public function gallery()
    {
        ...
        return view('Dinas.gallery', $data);
    }
    ...
    public function editFoto($id)
    {
        ...
        return view('Dinas.edit_foto', $data);
    }
    ...
    public function testimoni()
    {
        ...
        return view('Dinas.testimoni',$data);
    }
    ...
    public function editTestimoni($id)
    {
        ...
        return view('Dinas.edit_testimoni',$data);
    }
