...
class MasterController extends Controller
{
    ...
    public function testimoni()
    {
        ...
        return view('Master.testimoni', $data);
    }
    ...
    public function editTestimoni($id)
    {
        ...
        return view('Master.edit_testimoni', $data);
    }
    ...
    public function showAngket()
    {
        return view('Master.generate_angket');
    }
    public function kepuasanPelanggan()
    {
        ...
        return view('Master.kepuasan-pelanggan', $data);
    }
    public function lihatKepuasanPelanggan($id)
    {
        ...
        return view('Master.lihat-kepuasan-pelanggan', $data);
    }
}
