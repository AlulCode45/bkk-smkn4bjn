...
class OperatorController extends Controller
{
    public function storeImage(Request $request)
    {
        if ($request->hasFile('upload')) {
            ...
            $request->file('upload')->move('assets/media', $fileName);
    ...
    public function updateProfile(Request $request)
    {
        ...
        if ($moveFoto and User::find(Auth::user()->id)->update($update)) {
    ...
    public function visi()
    {
        ...
        return view('Operator.visi', $data);
    }
    ...
    public function misi()
    {
        ...
        return view('Operator.misi', $data);
    }
    ...
    public function mottoBkk()
    {
        ...
        return view('Operator.motto', $data);
    }
    ...
    public function strukturBkk()
    {
        ...
        return view('Operator.struktur_bkk', $data);
    }
    ...
    public function perusahaan()
    {
        ...
        return view('Operator.perusahaan', $data);
    }
    ...
    public function editPerusahaan($idPerusahaan)
    {
        ...
        return view('Operator.edit_perusahaan', $data);
    }
    ...
    public function lowongan()
    {
        ...
        return view('Operator.lowongan', $data);
    }
    public function tambahLowonganAction(Request $request)
    {
        ...
        $idPembuat = PerusahaanModel::find($request->perusahaan)->id_user;
        $save = [
    ...
    public function viewLowongan($id)
    {
        ...
        return view('Operator.view_lowongan', $data);
    }
    public function editLowongan($id)
    {
        ...
        return view('Operator.edit_lowongan', $data);
    }
    ...
    public function programkerja()
    {
        ...
        return view('Operator.programkerja', $data);
    }
    ...
    public function sambutankepalasekolah()
    {
        ...
        return view('Operator.sambutan_kepala_sekolah', $data);
    }
    ...
    {
        return view('Operator.tambah_berita');
    }
    public function tambahBeritaAction(Request $request)
    {
        ...
        if (NewsModel::insert($save)) {
            return redirect()->to(route('Operator.berita'))->with('success', 'Tambah berita sukses');
        } else {
    ...
    public function editBerita($id)
    {
        ...
        return view('Operator.edit_berita', $data);
    }
    ...
    public function gallery()
    {
        ...
        return view('Operator.gallery', $data);
    }
    ...
    public function editFoto($id)
    {
        ...
        return view('Operator.edit_foto', $data);
    }
    ...
    {
        $data = [
            'data_testimoni' => TestimoniModel::all()
        ];
        return view('Operator.testimoni', $data);
    }
    public function tambahTestemoni(Request $request)
    {
        $validator = Validator::make($request->all(), [
        ...
        if (TestimoniModel::insert($save)) {
            return redirect()->back()->with('success', 'Tambah testimoni sukses');
        } else {
            return redirect()->back()->with('error', 'Tambah testimoni gagal');
        }
    }
    public function editTestimoni($id)
    {
        ...
        return view('Operator.edit_testimoni', $data);
    }
    public function updateTestimoni(Request $request)
    {
        ...
        if (TestimoniModel::find($request->id)->update($update)) {
            return redirect()->back()->with('success', 'Edit testimoni sukses');
        } else {
            return redirect()->back()->with('error', 'Edit testimoni gagal');
        }
    }
    public function kepuasanPelanggan()
    {
        $data = [
            'kepuasan_pelanggan' => KepuasanPelangganModel::groupBy('id_user')
                ->join('users', 'users.id', '=', 'kepuasan_pelanggan.id_user')
                ->get()
        ];
        return view('Operator.kepuasan-pelanggan', $data);
    }
    public function lihatKepuasanPelanggan($id)
    {
        $data = [
            'kepuasan_pelanggan' => KepuasanPelangganModel::where('id_user', $id)
                ->join('users', 'users.id', '=', 'kepuasan_pelanggan.id_user')
                ->get()
        ];
        return view('Operator.lihat-kepuasan-pelanggan', $data);
    }
}
