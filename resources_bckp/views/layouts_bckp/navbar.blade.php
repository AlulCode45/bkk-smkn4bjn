        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link font1 px-3 nav-lowongan {{ Request::is('lowongan') ? 'hover-active' : '' }}"
                            aria-current="page" href="/lowongan">Lowongan</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle font1 informasi" href="#" id="navbarDropdown"
                        ...
                        <ul class="dropdown-menu informasiMenu" aria-labelledby="navbarDropdown">
                            <a class="nav-link p-2 hover text-dropdown" href="#">Berita Terbaru</a>
                            <a class="nav-link p-2 hover text-dropdown" href="#">Galeri / Kegiatan</a>
                            <a class="nav-link p-2 hover text-dropdown" href="{{ route('tracer_study') }}">Tracer
                                Study</a>
                            <a class="nav-link p-2 hover text-dropdown" href="#">Statistik</a>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link font1 px-3 nav-kontak" href="#">Kontak</a>
                    </li>
                    <li class="nav-item dropdown">
                        @if (Auth::check())
                            @if (Auth::user()->role == 4)
            ...
            <div class="container">
                ...
                <div class="ms-auto">
                    <span class="span-made-by text-white">Coded with <ion-icon name="heart-circle-outline"></ion-icon>
                        by
                        AMAL & Coach Arif Sulistiyo</span>
