...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/front-end-assets/css/tes.css') }}">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle font1 informasi {{ Request::is('berita') || Request::is('galeri') ? 'hover-active' : '' }}"
                        ...
                        <ul class="dropdown-menu informasiMenu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="nav-link p-2 hover text-dropdown" href="/maintenance">Statistik</a>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    @if (Auth::check())
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu profilekuMenu" aria-labelledby="navbarDropdown">
                                ...
                                @if (Auth::user()->role == 1)
                                    <a href="{{ route('siswa.lowonganKerja') }}" class="nav-link p-2 hover text-dropdown">Lowongan Kerja Saya</a>
                                @endif
