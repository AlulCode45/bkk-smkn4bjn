...
@section('content')
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mt-3">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Program Kerja BKK</li>
                </ol>
            </nav>
        </div>
    </div> --}}
    ...
    <div class="container">
        <div class="text-center">
            <h3 class="text-russo">Program Kerja BKK</h3>
        </div>
    </div>
    <div class="col ms-auto misi-bkk container">
        <h3 class="visimisi-bkk">Program Kerja BKK SMKN 4 Bojonegoro</h3>
        {!! $program !!}
    </div>
@endsection
